...
const SNAP_DISTANCE = 200;   // Increased from 150px to 200px for easier snapping
...
function arePiecesConnected(wordPieces, wordData) {
    ...
    for (let i = 0; i < sortedPieces.length - 1; i++) {
        ...
        if (orientation === 'horizontal') {
            ...
            // Increased tolerance to 30px for very forgiving detection
            if (gap > 30 || verticalAlign > 30) {
