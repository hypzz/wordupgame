...
const SNAP_DISTANCE = 200;   // Distance threshold for snapping pieces together
...
function arePiecesConnected(wordPieces, wordData) {
    ...
    for (let i = 0; i < sortedPieces.length - 1; i++) {
        ...
        if (orientation === 'horizontal') {
            ...
            // Increased tolerance to 20px for very forgiving detection
            if (gap > 20 || verticalAlign > 20) {
